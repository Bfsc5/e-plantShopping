...
function ProductList({ onHomeClick }) {
    ...
    const handleContinueShopping = (e) => { if (e) e.preventDefault(); setShowCart(false); };

    return (
        <div>
            <div className="navbar" style={styleObj}>
                <div className="luxury">
                    <img src="https://cdn.pixabay.com" alt="" style={{height:'50px'}}/>
                ...
                <div style={styleObjUl}>
                    ...
                    <a href="#" onClick={handleCartClick} style={styleA}>
                        <h1 className='cart'>
                            <svg xmlns="http://www.w3.org" viewBox="0 0 256 256" height="68" width="68">
                ...
                <div className="product-grid">
                    {plantsArray.map((categoryObj) => (
                        <div key={categoryObj.category} style={{width:'100%'}}>
                            <h2 style={{textAlign: 'center', margin: '20px 0'}}>{categoryObj.category}</h2>
                            <div style={{display: 'flex', flexWrap: 'wrap', justifyContent: 'center'}}>
                                {categoryObj.plants.map((plant) => (
                                    <div className="product-card" key={plant.name} style={{border: '1px solid #ccc', margin: '10px', padding: '10px', borderRadius: '8px', width: '300px'}}>
                                        <img className="product-image" src={plant.image} alt={plant.name} style={{width: '100%', height: '200px', objectFit: 'cover'}} />
                                        <div className="plant-details">
                                            ...
                                            <button 
                                                ...
                                                style={{backgroundColor: addedToCart[plant.name] ? 'gray' : '#4CAF50', color: 'white', border: 'none', padding: '10px', cursor: 'pointer', borderRadius:'5px'}}
                                            >
